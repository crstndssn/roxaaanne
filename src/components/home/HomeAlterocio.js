...
const HomeRoxanne = () => {
  ...
  return (
    <div className='homeRoxanne'>

      <h2>Roxanne</h2>
      <p>historias anacrónicas interplatanarias desde las montañas hasta el mar, siguiendo a la luna esperando un nuevo amanecer</p>
