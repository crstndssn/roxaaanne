...
const AddKam = () => {
  ...
  // categories
  const categories = ['kam', 'forestando', 'roxanne']
  ...
  return (
    <>
      <Navigation />
      <form className='kam-add' onSubmit={addPost}>

        <div className='kam-add__image'>
          {
        ...
        <div className='kam-add__percentage'>
          <div className='kam-add__percentage--bar' style={progressPercentage}></div>
          <span className='kam-add__percentage--number'>{Math.round(percentage)}%</span>
        </div>

        {/* imagenes */}
        <div className='kam-add__images'>
        ...
        {/* id */}
        <div className='kam-add__id'>
          <input
            onChange={(e) => { postId(e) }}
            name="upload-image"
            type="text"
            placeholder='post id'
            className='kam-add__id--input'
          />
        </div>

        <div className='kam-add__save-options'>
          <select
            className='kam-add__year'
