...
const AddRoxy = () => {
  ...
  const [category, setCategory] = useState('kam');
  ...
  // categories
  const categories = ['roxanne', 'forestando', 'kam']
  ...
  return (
    <>
      <Navigation />
      <form className='roxy-add' onSubmit={addPost}>

        <div className='roxy-add__image'>
          {
        ...
        <div className='roxy-add__percentage'>
          <div className='roxy-add__percentage--bar' style={progressPercentage}></div>
          <span className='roxy-add__percentage--number'>{Math.round(percentage)}%</span>
        </div>

        {/* imagenes */}
        <div className='roxy-add__images'>
        ...
        {/* id */}
        <div className='roxy-add__id'>
          <input
            onChange={(e) => { postId(e) }}
            name="upload-image"
            type="text"
            placeholder='post id'
            className='roxy-add__id--input'
          />
        </div>

        <div className='roxy-add__save-options'>
          <select
            className='roxy-add__year'
